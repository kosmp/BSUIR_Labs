...
namespace Lab2.Collections
{
    ...
    [Serializable] 
    public class NoSuchObjectInCollection : Exception
    {
        public NoSuchObjectInCollection(string message) : base(message) { }
    }
    ...
    public class MyCustomCollection<T> : IEnumerable<T>, ICustomCollection<T>
    {
        ...
        {
            if (item == null) throw new NoSuchObjectInCollection("No null item in collection.");
            ...
            if (!inCollection)
                throw new NoSuchObjectInCollection("No such item in collection.");
        }
